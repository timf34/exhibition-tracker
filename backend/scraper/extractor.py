...
class LLMExtractor:
    def __init__(self, model_listing="gpt-5-mini", model_detail="gpt-5-mini"):
        # Set a conservative client timeout and a couple retries
